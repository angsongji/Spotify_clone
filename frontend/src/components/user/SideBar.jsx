...
const SideBar = () => {
        ...
        <div className="w-full h-full flex flex-col text-[var(--light-gray3)] text-base">
            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button className="text-2xl font-bold cursor-pointer" onClick={() => setIsFull(false)}>
                        <HiMiniArrowLeft />
                    </button>
                </div>
    ...
    const NoneUser = () => (
        <div className="flex flex-col gap-4 p-5 bg-gradient-to-b from-neutral-800 to-neutral-900 rounded-lg w-[20vw]">
            <h2 className="text-white font-bold text-base">Muốn tạo danh sách phát và tận hưởng âm nhạc của riêng bạn?</h2>
    ...
    const LikedSongCard = () => (
        <div className="flex items-center gap-3 cursor-pointer p-2 hover:bg-[var(--light-gray2)] rounded-md">
            ...
            <div className="flex flex-col justify-center h-full gap-1">
                ...
                <div className="text-gray-400 text-sm">Của tôi • {user?.liked_songs_data.length} bài hát</div>
            </div>
        </div>
    )
